...
def main():
    ...
    fwd_test, opt, criterion,scheduler=get_net_resnet(device,hiden_num=1000,dropout=0.1,features=1000, Y_prediction_size=6)
    ...
    date="_RESNET152_Bands_11June_2e-5_100epc_h1000_f1000_64_MSE_3top3freq"
