...
def main():
    ...
    fwd_test, opt, criterion,scheduler=get_net_resnet(device,hiden_num=1100,dropout=0.3,features=1000, Y_prediction_size=parser.pred_size)
    ...
    date="_RESNET152_Bands_26Nov_2e-4_25epc_ADAM_64_MSE_batch64_1.0004_feat1000_1out"
    run = "output_26Nov"
